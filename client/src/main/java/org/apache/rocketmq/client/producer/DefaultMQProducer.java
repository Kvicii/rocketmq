...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
     ...
     * 消息重试时选择另外一个broker时 是否不等待存出结果就返回 默认为false
     */
     ...
     * 异步发送消息 sendCallback是发送成功之后的回调函数
     * <p>
     ...
     * 同步发送消息 发送到指定的消息队列 时间超过timeout抛出异常
     *
     * @param msg     Message to send.
     * @param mq      Target message queue.
     * @param timeout send timeout.
     ...
     * 异步发送消息 发送到指定的消息队列 时间超过timeout抛出异常
     *
     * @param msg          Message to send.
     * @param mq           Target message queue.
     * @param sendCallback Callback to execute on sending completed, either successful or unsuccessful.
     ...
     * 同步 发送消息 指定选择算法 覆盖生产者默认的消息队列负载算法
     *
     * @param msg      Message to send.
     ...
     * 同步发送消息 指定选择算法 覆盖生产者默认的消息队列负载算法 时间超过timeout抛出异常
     *
     * @param msg      Message to send.
     * @param selector Message queue selector, through which we get target message queue to deliver message to.
     * @param arg      Argument to work along with message queue selector.
     ...
     * 异步发送消息 指定选择算法 覆盖生产者默认的消息队列负载算法
     *
     * @param msg          Message to send.
     ...
     * 异步发送消息 指定选择算法 覆盖生产者默认的消息队列负载算法 时间超过timeout抛出异常
     *
     * @param msg          Message to send.
     * @param selector     Message selector through which to get target message queue.
     * @param arg          Argument used along with message queue selector.
    ...
    /**
     * 将一批消息封装成一个MessageBatch对象
     * 将一批消息设置在Message的body(byte[])中
     *
     * @param msgs
     * @return
     * @throws MQClientException
